...
При открытии формы все поля, кроме типа точки маршрута, пусты, дополнительные опции не выбраны. Предустановленный тип точки маршрута разработчик определяет самостоятельно.
...
Изменение дат и времени в соответствии с часовым поясом пользольвателя остаётся на усмотрение разработчика.
...
Сервер расположен по адресу https://20.ecmascript.pages.academy/big-trip.

Спецификация по взаимодействию с сервером в формате OpenAPI — https://20.ecmascript.pages.academy/big-trip/spec.
